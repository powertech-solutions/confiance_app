            ...
            <div>
                <div className="rounded-[8px] bg-white px-[2em] pt-[1.7em] pb-[2.5em]">
                    ...
                    <div className="flex flex-col gap-[1em]">
                        <h3 className="text-center font-semibold text-[0.9em]">Modifier votre mot de passe</h3>
                        <input type="password" placeholder="Nouveau mot de passe" className="border w-[21em] py-[0.45em] px-[0.7em] placeholder:text-[0.9em] rounded-[5px] outline-none text-[0.9em]" />
                        <input type="password" placeholder="Confirmer le mot de passe" className="border w-[19em] py-[0.4em] px-[0.7em] placeholder:text-[0.8em] rounded-[5px] outline-none" />
