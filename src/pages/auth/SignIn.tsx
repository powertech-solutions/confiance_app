...
export default function SignIn() {
    return (
        <div className="h-full relative flex justify-center pt-[3em]">
            <button className="absolute top-[1em] left-[1em] text-white font-medium flex items-center gap-[0.3em]"><Icon icon="si:arrow-left-fill" className="text-[1.3em]" />Retour</button>
            <div>
                <div className="rounded-[8px] bg-white px-[2em] pt-[1.7em] pb-[2.5em]">
                    ...
                    <div className="flex flex-col gap-[1em]">
                        ...
                        <input type="text" placeholder="Mot de passe" className="border w-[19em] py-[0.4em] px-[0.7em] placeholder:text-[0.8em] rounded-[5px]" />
                    </div>
                    ...
                    <div className="mt-[1em]">
                        <p className="text-[0.85em] text-center leading-[2em]">Vous n'avez pas de compte ? <Link to={"/"} className="text-[#0A69FB] font-medium hover:underline">Enregitrez-vous</Link> <br /> <Link to={"/"} className="text-[#0A69FB] font-medium hover:underline">Mot de pas oublié</Link></p>
                    </div>
                </div>
            </div>
        </div>
